...
public class SecondLargest {
    public static void main(String[] args) {
        ...
        Optional<Integer> secondLarget = list.stream().sorted(Comparator.comparingInt(Integer::intValue).reversed()).skip(1).findFirst();
        secondLarget.ifPresent(System.out::println);

...
public class FindEmpTotalSalBySpecDept {
    public static void main(String[] args) {
        ...
        double totalSal = list.stream().filter(emp -> emp.getDeptName().equalsIgnoreCase("IT")).mapToDouble(Employee::getSalary).sum();
        System.out.println(totalSal);

        double sal = list.stream().filter(emp -> emp.getDeptName().equalsIgnoreCase("IT")).mapToDouble(Employee::getSalary).sum();

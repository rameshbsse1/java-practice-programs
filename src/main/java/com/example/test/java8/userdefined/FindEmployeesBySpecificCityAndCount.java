...
public class FindEmployeesBySpecificCityAndCount {
    public static void main(String[] args) {
        ...
        list.stream().filter(emp -> emp.getLocation().equals("Hyd")).map(Employee::getName).forEach(System.out::println);

        long count = list.stream().filter(emp -> emp.getLocation().equalsIgnoreCase("Hyd")).count();
